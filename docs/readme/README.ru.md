...
<p align="center">
  ...
  <a href="#справочник-инструментов-128-инструментов">Инструменты (128)</a> &bull;
...
<td>17 категорий, 128 инструментов параллельно</td>
</tr>
<tr>
...
| [Продвинутый JPEG](#-продвинутый-jpeg-7) | 7 | F5, JSteg, OutGuess, обнаружение PVD, скользящее окно хи-квадрат, стеганализ crop-рекалибровки, совместимость инструментов |
| [Видеостеганография](#-видеостеганография-8) | 8 | AVI-кадр LSB, межкадровый анализ, сравнение кадров, метаданные, структура, данные EOF |
| [GIF-стеганография](#-gif-стеганография-8) | 8 | Палитра LSB, энтропия подблоков LZW, расширения комментариев, расширения приложений, анализ кадров |
| [Сетевая стеганография](#-сетевая-стеганография-8) | 8 | Скрытые каналы PCAP, анализ заголовков IP/TCP, полезные нагрузки ICMP, DNS-туннелирование, HTTP-заголовки, тайминг |
| [MP3-стеганография](#-mp3-стеганография-7) | 7 | Скрытые данные ID3, анализ фреймов, манипуляция паддингом, анализ сэмплов, метаданные, структура |
| [Spread Spectrum](#-spread-spectrum-5) | 5 | Спектр амплитуд DFT, автокорреляция, обнаружение водяных знаков, анализ шумового пола, обнаружение patchwork |
| [BPCS-анализ](#-bpcs-анализ-5) | 5 | Сегментация сложности битовых плоскостей, картирование сложности, пороговый анализ, извлечение данных, оценка ёмкости |
| [Стеганография архивов](#-стеганография-архивов-7) | 7 | Свободные пространства ZIP, дополнительные поля, комментарии, обнаружение полиглотов, анализ структуры, метаданные |
| [Создание и встраивание](#-создание-и-встраивание-7) | 7 | Инъекция EOF, инъекция метаданных, кодирование пробелами, нулевой шифр, создание полиглотов, инъекция комментариев, встраивание в палитру |
| [Стеганография QR-кодов](#-стеганография-qr-кодов-6) | 6 | Обнаружение стего QR, анализ структуры, ёмкость ECC, анализ модулей, извлечение данных, сравнение |
...
- **17 провайдеров, 1 сервер** &mdash; Каждая категория анализа — это независимый модуль. AI-агент выбирает, какие инструменты использовать, исходя из контекста расследования.
